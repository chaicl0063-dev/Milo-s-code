    ...
    <header className="relative z-20">
      <div className={`${container} flex h-14 items-center justify-between md:h-16 lg:h-[76px]`}>
        ...
        <div className="flex items-center gap-8">
          ...
          <a href={appUrl} className="group/btn inline-flex h-10 touch-manipulation items-center rounded-full bg-(--v2-accent) px-5 text-[14px] font-semibold text-white shadow-[0_4px_12px_rgba(10,111,184,0.25)] transition-[color,background-color] duration-150 ease-[cubic-bezier(0.2,0,0,1)] fine:hover:bg-(--v2-accent-deep) motion-reduce:transition-none lg:h-11 lg:px-6">
