...
const en = {
  ...
  aboutTitle: "About",
  aboutBody:
    "Around You shows what is near you and tells its story. Narrations are generated by an AI model from public sources and can be wrong; treat dates and figures as a starting point, not the final word.",
  version: "Version",
...
const zh: Record<keyof typeof en, string> = {
  ...
  aboutTitle: "关于",
  aboutBody: "「身边」帮你看见周围有什么，并讲出它的故事。讲解由 AI 根据公开资料生成，可能出错，日期和数字仅供参考。",
  version: "版本",
