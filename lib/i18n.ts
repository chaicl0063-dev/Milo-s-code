...
const en = {
  ...
  dataSourcesBody:
    "Places and descriptions come from Wikipedia, OpenStreetMap and Wikidata, all free and community-maintained. In mainland China, Amap data is added when configured. Map tiles © OpenStreetMap contributors.",
  aboutTitle: "About",
  aboutBody:
...
const zh: Record<keyof typeof en, string> = {
  ...
  dataSourcesBody: "地点和介绍来自 Wikipedia、OpenStreetMap、Wikidata 三个免费的社区数据源，中国境内配置后叠加高德数据。地图底图 © OpenStreetMap 贡献者。",
  aboutTitle: "关于",
