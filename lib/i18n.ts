...
const en = {
  ...
  clearCacheHint: "Forgets your saved location, language and offline cache. Nothing is stored on a server.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  clearCacheHint: "会忘掉保存的位置、语言和离线缓存。所有数据只在你的手机上，服务器不存任何东西。",
